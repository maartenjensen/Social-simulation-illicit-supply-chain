...
public class Agent4Retailer extends BaseAgent {
	...
	public Agent4Retailer(final Context<Object> context, int id, CountryAgent country, NdPoint newPos, double money, double sellPrice, double averageBuyCost, double profitPercentage,
		...
		super(id, country, SCType.RETAIL, newPos, money, sellPrice, averageBuyCost, profitPercentage, maxPackageSize,
